...
#
appModule = angular.module("TechGrindApp.controllers.list.tableview", [])
appModule.controller "ListEventsCtrl", [ "$scope", "steam", "$http",  ($scope, steam, http) ->
    $scope.eventsData = eventsData
    $scope.listClickLink = (linkid) ->
