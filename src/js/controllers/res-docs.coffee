...
# 
###
appModule = angular.module("TechGrindApp.controllers.res-docs", [])
appModule.controller "ResourcesDocsCtrl", [ "$scope", "$location", "steam", "$rootScope", "$http", ($scope, loc, steam, $rootScope, $http) ->
]
appModule.factory "DocsSharedData", ->
  itemShared: {}
