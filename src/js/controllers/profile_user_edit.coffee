...
appModule.controller "ProfileUserEditCtrl", [
	...
	($scope, steam, http, $rootScope, filterFilter) ->
		...
		console.log("Edited user profile", $scope.userprofile)
...
# watch maintabs for changes
		...
		$scope.submitEdit = ->
			console.log sexpr("Edited user profile", $scope.userprofile)
			console.log sexpr("Maintabs profile", $scope.maintabs)
]
